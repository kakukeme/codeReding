...
- 5 Control loops（控制循环）
  - 5.1 Deployments controller
    - [Deployments controller 启动](https://arthurchiao.art/blog/what-happens-when-k8s-creates-pods-4-zh/#deployments-controller-启动)
    - [创建 Deployment：回调函数处理](https://arthurchiao.art/blog/what-happens-when-k8s-creates-pods-4-zh/#创建-deployment回调函数处理)
    - [主处理循环](https://arthurchiao.art/blog/what-happens-when-k8s-creates-pods-4-zh/#主处理循环)
    - [执行扩容（scale up）](https://arthurchiao.art/blog/what-happens-when-k8s-creates-pods-4-zh/#执行扩容scale-up)
    - [小结](https://arthurchiao.art/blog/what-happens-when-k8s-creates-pods-4-zh/#小结)
  - 5.2 ReplicaSets controller
    - [ReplicaSets controller 启动](https://arthurchiao.art/blog/what-happens-when-k8s-creates-pods-4-zh/#replicasets-controller-启动)
    - [创建 ReplicaSet：回调函数处理](https://arthurchiao.art/blog/what-happens-when-k8s-creates-pods-4-zh/#创建-replicaset回调函数处理)
    - [主处理循环](https://arthurchiao.art/blog/what-happens-when-k8s-creates-pods-4-zh/#主处理循环-1)
    - [Owner reference](https://arthurchiao.art/blog/what-happens-when-k8s-creates-pods-4-zh/#owner-reference)
  - [5.3 Informers](https://arthurchiao.art/blog/what-happens-when-k8s-creates-pods-4-zh/#53-informers)
  - 5.4 Scheduler（调度器）
    - [调用栈概览](https://arthurchiao.art/blog/what-happens-when-k8s-creates-pods-4-zh/#调用栈概览)
    - [调度过程](https://arthurchiao.art/blog/what-happens-when-k8s-creates-pods-4-zh/#调度过程)
    - 调度算法
      - [注册默认 predicates](https://arthurchiao.art/blog/what-happens-when-k8s-creates-pods-4-zh/#注册默认-predicates)
      - [对筛选出的 node 排序](https://arthurchiao.art/blog/what-happens-when-k8s-creates-pods-4-zh/#对筛选出的-node-排序)
    - [创建 `v1.Binding` 对象](https://arthurchiao.art/blog/what-happens-when-k8s-creates-pods-4-zh/#创建-v1binding-对象)
    - [kube-apiserver 更新 pod 对象](https://arthurchiao.art/blog/what-happens-when-k8s-creates-pods-4-zh/#kube-apiserver-更新-pod-对象)
    - [自定义调度器](https://arthurchiao.art/blog/what-happens-when-k8s-creates-pods-4-zh/#自定义调度器)
  - [5.5 小结](https://arthurchiao.art/blog/what-happens-when-k8s-creates-pods-4-zh/#55-小结)
