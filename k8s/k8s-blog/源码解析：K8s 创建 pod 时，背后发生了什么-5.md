...
- 6 kubelet
  - 6.1 Pod sync（状态同步）
    - [同步过程](https://arthurchiao.art/blog/what-happens-when-k8s-creates-pods-5-zh/#同步过程)
    - [Pod 状态](https://arthurchiao.art/blog/what-happens-when-k8s-creates-pods-5-zh/#pod-状态)
  - 6.2 CRI 及创建 pause 容器
    - [CRI SyncPod](https://arthurchiao.art/blog/what-happens-when-k8s-creates-pods-5-zh/#cri-syncpod)
    - [CRI create sandbox](https://arthurchiao.art/blog/what-happens-when-k8s-creates-pods-5-zh/#cri-create-sandbox)
    - [Create sandbox：docker 相关代码](https://arthurchiao.art/blog/what-happens-when-k8s-creates-pods-5-zh/#create-sandboxdocker-相关代码)
  - 6.3 CNI 前半部分：CNI plugin manager 处理
    - [调用栈概览](https://arthurchiao.art/blog/what-happens-when-k8s-creates-pods-5-zh/#调用栈概览)
  - 6.4 CNI 后半部分：CNI plugin 实现
    - [调用栈概览](https://arthurchiao.art/blog/what-happens-when-k8s-creates-pods-5-zh/#调用栈概览-1)
    - [CNI 插件实现举例：Bridge](https://arthurchiao.art/blog/what-happens-when-k8s-creates-pods-5-zh/#cni-插件实现举例bridge)
    - [CNI 插件实现举例：Noop](https://arthurchiao.art/blog/what-happens-when-k8s-creates-pods-5-zh/#cni-插件实现举例noop)
    - [CNI 插件实现举例：Cilium](https://arthurchiao.art/blog/what-happens-when-k8s-creates-pods-5-zh/#cni-插件实现举例cilium)
  - [6.5 为容器配置跨节点通信网络（inter-host networking）](https://arthurchiao.art/blog/what-happens-when-k8s-creates-pods-5-zh/#65-为容器配置跨节点通信网络inter-host-networking)
  - 6.6 创建 `init` 容器及业务容器
    - [调用栈概览](https://arthurchiao.art/blog/what-happens-when-k8s-creates-pods-5-zh/#调用栈概览-2)
    - [具体过程](https://arthurchiao.art/blog/what-happens-when-k8s-creates-pods-5-zh/#具体过程)
- [7 结束](https://arthurchiao.art/blog/what-happens-when-k8s-creates-pods-5-zh/#7-结束)
- [参考资料](https://arthurchiao.art/blog/what-happens-when-k8s-creates-pods-5-zh/#参考资料)
...
1. [The Mysterious Container `net.core.somaxconn` (2022)](https://arthurchiao.art/blog/the-mysterious-container-somaxconn/)
